      ...
      //this code is for smooth scroll and nav selector
            $(document).ready(function () {
              ...
              $('a[href^="#"]').on('click', function (e) {
                  ...
                  headerHeight = $(".top-header").height();
          ...
          function onScroll(event){
              ...
              $('.navbar-default .navbar-nav>li>a').each(function () {
                  ...
                  // console.log("refElement.position().top + refElement.height() = " + (refElement.position().top + refElement.height()));
                  // console.log("refElement.position().top <= scrollPos = " + (refElement.position().top <= scrollPos));
                  // console.log("refElement.position().top + refElement.height() > scrollPos = " + (refElement.position().top + refElement.height() > scrollPos));
