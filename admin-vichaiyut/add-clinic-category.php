...
<body>
                    ...
                    <div class="panel-body">
                        <form id="clinic-form" role="form" method="post" enctype="multipart/form-data" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="open_time" rows="2"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Venue</label>
                                        <textarea class="form-control" name="venue" rows="2"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Appointment</label>
                                        <textarea class="form-control" name="appointment" rows="2"></textarea>
                                    </div>
    ...
    <script type="text/javascript" src="process/js/add-clinic-category.js" ></script>
</body>
</html>
