...
<body>
            ...
            <div id="page-inner">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel-heading">
                       Edit Clinic Category
                    </div>
                    <div class="panel-body">
                        <form id="clinic-form" role="form" method="post" enctype="multipart/form-data" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="detail" rows="4"><?= $row['detail']?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Open Hours</label>
                                        <textarea class="form-control" name="open_time" rows="2"><?= $row['open_hours']?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Venue</label>
                                        <textarea class="form-control" name="venue" rows="2"><?= $row['venue']?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Appointment</label>
                                        <textarea class="form-control" name="appointment" rows="2"><?= $row['appointment']?></textarea>
                                    </div>
    ...
    <script type="text/javascript" src="process/js/edit-clinic-category.js" ></script>
</body>
</html>
