            ...
            <div id="page-inner">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel-body">
                        <form id="hilight-form" role="form" method="post" enctype="multipart/form-data" action="process/edit-hilightprocess.php">
                                    ...
                                    <div class="form-group">
                                        <label>Link</label>
                                        <input name="link" class="form-control" type="text" value="<?=$row['link']?>">
                                    </div>
                                    <div class="form-group">
