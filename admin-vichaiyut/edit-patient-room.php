...
$stmt_gallery = $db_con->prepare("SELECT * FROM patient_room_gallery WHERE patient_ID=:id");
$stmt_gallery->execute(array(":id"=>$id));
$row_gallery = $stmt_gallery->fetchAll();
            ...
            <div id="page-inner">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel-body">
                        <form id="patient-form" role="form" method="post" enctype="multipart/form-data" action="process/edit-patientroomprocess.php">
                                    ...
                                    <div id="list">
                                        <?php
                                            foreach ($row_gallery as $result) {
                                        ?>
                                        <img class="thumb" src="../<?= $result["path_img"]?>">
                                        <?php
                                            }
                                        ?>
                                    </div>
