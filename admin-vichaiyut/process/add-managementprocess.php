...
if(isset($_POST['btn-save']))
{
	...
	if(isset($_FILES["file"]["type"]))
	{
		...
		{ 
			...
			$stmt = $db_con->prepare("INSERT INTO management_team (name,position,education,experiences,award,is_doctor,specialty,language_spoken,medical_school,residencies,fellowship,certificate,path_img,create_date) VALUES (:name,:position,:education,:experiences,:award,:is_doctor,:specialty,:language,:medical_school,:residencies,:fellowship,:certificate,:path_img,now())");
