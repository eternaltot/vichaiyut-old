...
if(isset($_POST['btn-save']))
{
	...
	if(isset($_FILES["file"]["type"]))
	{
		...
		{ 
			...
			$stmt = $db_con->prepare("INSERT INTO clinic (name,clinic,specialty,language_spoken,medical_school,residencies,fellowship,certificate,path_img,create_date) VALUES (:name,:clinic,:specialty,:language_spoken,:medical_school,:residencies,:fellowship,:certificate,:path_img,now())");
